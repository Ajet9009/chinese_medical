  ...
  <div class="app-frame">
    <header class="auth-bar">
      ...
      <nav class="auth-nav">
        ...
        <router-link v-if="auth.isAdmin" class="nav-pill" to="/admin">管理</router-link>
      </nav>
      <div class="auth-user">
        ...
        <button class="btn ghost sm" type="button" @click="logout_step_01">退出</button>
      </div>
    </header>
    <div class="app-body">
      <router-view />
